...
<head>
    ...
    <title>Semua Laporan Barang - FoundIt</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css">
    <style>
        body { font-family: 'Poppins', sans-serif; background-color: #f1f1ef; color: #333; }
        
        /* NAVBAR FOUNDIT UPDATE (Warna Background Asli #fdfbf7) */
...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-5">
            <h3 class="fw-bold m-0"><i class="bi bi-boxes text-muted me-2"></i> Semua Laporan Barang</h3>
            
            <ul class="nav nav-pills bg-white p-1 rounded-pill shadow-sm" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active active-hilang" id="pills-hilang-tab" data-bs-toggle="pill" data-bs-target="#pills-hilang" type="button" role="tab" aria-controls="pills-hilang" aria-selected="true">
                        <i class="bi bi-exclamation-circle-fill me-1"></i> Barang Hilang
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link active-temuan" id="pills-temuan-tab" data-bs-toggle="pill" data-bs-target="#pills-temuan" type="button" role="tab" aria-controls="pills-temuan" aria-selected="false">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-hilang" role="tabpanel" aria-labelledby="pills-hilang-tab">
                <div class="row g-4">
