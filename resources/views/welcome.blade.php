...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold fs-3" href="#" style="color: #750909;">Found<span style="color: #212c6b;">It</span></a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <span class="badge rounded-pill px-3 py-2 mb-3" style="background-color: #fff2f0; color: #750909">
                        📍 SOLUSI BARANG HILANG NO. 1
                    </span>
                    <h1 class="display-3 fw-bold mb-4">Barang Hilang? <br> <span style="color: #750909;">FoundIt</span> Solusinya.</h1>
                    <p class="lead text-secondary mb-5">Platform komunitas untuk membantu mengembalikan barang temuan kepada pemilik sahnya. Cepat, aman, dan terpercaya.</p>
                    <div class="d-grid d-md-flex gap-3 justify-content-center justify-content-lg-start">
                        ...
                        <a href="#fitur" class="btn btn-outline-foundit px-5 py-3 fs-5">Cari Barang Hilang</a>
                    </div>
                </div>
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="{{ asset('images/logo-foundit.png') }}" class="img-fluid" alt="FoundIt Illustration">
                </div>
            </div>
        </div>
    </header>
