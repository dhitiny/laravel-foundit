...
<head>
    ...
    <title>Monitoring Barang Hilang - FoundIt</title>
...
<body class="text-gray-700 antialiased bg-[#fdfbf7]">
    ...
    <div class="fixed top-0 left-0 h-screen w-[260px] bg-[#041942] text-white p-6 z-50 flex flex-col justify-between shadow-xl">
        <div class="overflow-y-auto pr-1 custom-scrollbar">
            ...
            <a href="{{ route('admin.monitoring.hilang') }}" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-sm font-semibold text-white bg-[#C11720] shadow-md shadow-[#C11720]/20 mb-2">
                <i class="bi bi-search-heart text-lg text-white"></i> Monitor Barang Hilang
            </a>
    ...
    <div class="ml-[260px] p-8 max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="flex justify-between items-center pb-4 border-b-2 border-[#0C324A]/5">
            <div class="flex items-center space-x-3">
                <div class="bg-rose-500/10 p-2.5 rounded-2xl">
                    <i class="bi bi-search-heart text-2xl text-rose-600"></i>
                </div>
                <div>
                    <h2 class="text-2xl font-bold text-[#0C324A] tracking-tight">Monitoring Laporan Barang Hilang</h2>
                    <p class="text-xs text-gray-400 mt-0.5">Pantau status publikasi barang yang dilaporkan hilang oleh pengguna</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-3">
                <div class="p-3 rounded-xl bg-rose-50 text-rose-600 border border-rose-100 text-lg">
        ...
        <div class="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4 justify-between items-center">
            <div class="relative w-full md:w-96">
                ...
                <input type="text" id="tableSearch" onkeyup="liveSearchTable()" 
                       ...
                       placeholder="Cari nama barang, pelapor, lokasi...">
            </div>
                            ...
                            <tr>
                                <td colspan="7" class="text-center text-gray-400 italic py-16">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <span class="text-sm">Belum ada laporan barang hilang masuk.</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
